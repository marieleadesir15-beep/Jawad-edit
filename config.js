...
STATUS_REPLY_MSG: process.env.STATUS_REPLY_MSG || "✅️ Status Viewed By Mr Christ X MD", // // Input Yours custom...
MODE: process.env.MODE || "public", // Put private or public or inbox or groups
OWNER_NUMBER: process.env.OWNER_NUMBER || "50937081286", // Only 1 owner Number Here, others Add to sudo numbers...
OWNER_NAME: process.env.OWNER_NAME || "亗Ｍｒｃｈｒｉｓｔｘ亗", // Input Yours custom...(Maintain font for Flow)
...
BOT_NAME: process.env.BOT_NAME || "Christ X Bot", //  don't change 
BOT_PIC: process.env.BOT_PIC || "https://files.catbox.moe/9obrlz.jpeg", //  don't change 
AUTO_AUDIO: process.env.AUTO_AUDIO || "false",
AUTO_BIO: process.env.AUTO_BIO || "false",
AUTO_BIO_QUOTE: process.env.AUTO_BIO_QUOTE || "i am Mr Christ X md",
